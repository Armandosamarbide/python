...
print("Hoy es",datetime.datetime.now().day,", mes",datetime.datetime.now().month,"hora",datetime.datetime.now().hour,datetime.datetime.now().minute,datetime.datetime.now().second)
