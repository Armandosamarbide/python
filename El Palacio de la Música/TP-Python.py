## Trabajo práctico Python: Nivel Inicial
## Alumno: Martín B. Salduna
## Docente: Ing. Juan Barreto
...
def alta():
    ...
    tk.Button(frame_center, text="Guardar", command=grabar_alta).pack(pady=15)

## Grabamos el alta en la BBDD
...
def ejecutar_modificacion(titulo_buscado):
    ...
    if registro:
        ...
        tk.Button(frame_center, text="Guardar cambios",
                command=lambda: grabar_modificacion(registro[0])).pack(pady=5)
...
def grabar_modificacion(id_registro):
