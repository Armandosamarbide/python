## Esta funcionalidad controla la modificación y guardado de registros en la BBDD
...
class ModificarDisco:
    ...
    def ejecutar_busqueda(self):
        ...
        try:
            ...
            self.text_output.insert(tk.END, f"Error en la búsqueda: {e}\n")
    ...
    def guardar_cambios(self):
        ...
        try:
            ...
            self.text_output.insert(tk.END, f"Error al modificar el registro: {e}\n")
