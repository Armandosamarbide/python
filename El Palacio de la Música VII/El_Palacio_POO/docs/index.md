...
## Archivos incluídos en el proyecto
    ...
    decorador.md # Registro de ejecución de las funciones principales
    ...
    Decorador (decoradores.py) # Registro de ejecución de las funciones principales de la aplicación.