## Patrón adaptador: conecta dos interfases que en principio no serían compatibles
...
class Motor():
    ...
    def salida(cls, voltaje_entrada):
        if voltaje_entrada > cls.voltaje_maximo:
            print("Con voltaje de: %s V se quema"%(voltaje_entrada))
            
        elif voltaje_entrada < cls.voltaje_minimo:
            print("Con voltaje de: %s V no prende"%(voltaje_entrada))
        else: 
            print("Con voltaje de: %s V funciona"%(voltaje_entrada))
